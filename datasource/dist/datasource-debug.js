define("value/datasource/1.0.0/datasource-debug", [ "$-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug" ], function(require, exports, module) {
    "use strict";
    var $ = require("$-debug");
    ...
    var DataSource = Base.extend({
        ...
        initialize: function(config) {
            ...
            // 如果 abort 会清空 callbacks，之前的请求果都不会执行
            this.id = 0;
            this.callbacks = [];
