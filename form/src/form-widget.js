...
//        Implements: Templatable,
        attrs:{
            ...
            nodeData:{},
            btns:{},//按钮点击事件统一在此注册
            commonValid:true,//是否为jquery-validator常规验证
            validateCfg:{
                rules:{},
                messages:{}
            }
        ...
        events: {
            "click button": function (e) {
                ...
                var btns = self.get("btns"),
                    btnObj = btns[btnkey];//此时btns已经被转成对象形式,子类自行转换
